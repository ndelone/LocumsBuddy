...
class LocalNotificationManager {
    ...
    func scheduleNotifications() -> Void {
        DispatchQueue.main.async {
            for notification in self.notifications {
                ...
                //Set the trigger for the notification, for debugging.
    ...
    func currentDateComponents(reminderDate: Date)->DateComponents{
        ...
        let dateTime = DateComponents(calendar: calendar, year: year, month: month, day: day, hour: 8, minute:0, second: 0)
        return dateTime
    }
